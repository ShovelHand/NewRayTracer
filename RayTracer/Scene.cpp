...
{
	Sphere* sphere1 = new Sphere(vec3(0.45f, 0.7f, 2.0f), 0.25f, Colour(255, 0, 0), 50);
	Spheres.push_back(sphere1);

	Sphere* sphere4 = new Sphere(vec3(0.2f, 0.45f, 1.8f), 0.1f, Colour(150, 0, 150), 10000);
	Spheres.push_back(sphere4);
	//Sphere* sphere5 = new Sphere(vec3(-0.5f, -1.0f, 0.5f), 0.4f, Colour(150, 155, 150), 100);
	//Spheres.push_back(sphere5);
	
	LightSource* light1 = new LightSource(vec3(0.0f, 0.0f, 2.0f), Colour(150, 150, 150), 5);
